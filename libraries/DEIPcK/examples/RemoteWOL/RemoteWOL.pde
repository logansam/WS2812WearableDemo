...
/*    RemoteWOL                                                         */
/*                                                                      */
/*    A chipKIT Server implementation                                   */
...
/*    3/27/2012(KeithV): Made consistent with WiFi implementation       */
...
byte localStaticIP = 10;                                       // this will be the gateway IP with the last byte being 190
...
CMDMSG state = DYNAMICIPBEGIN;           // Get our network info first
    ...
    case RESTFORAWHILE:
        {
            ...
            {
                fFirstEntry = true;
                state = DYNAMICIPBEGIN;           // Just start over
                stateNext = MAKESTATICIP;
